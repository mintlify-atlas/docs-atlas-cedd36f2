---
title: "The go-chi Ecosystem: Official Packages and Integrations"
sidebarTitle: "Ecosystem"
description: "Explore official go-chi packages for CORS, JWT auth, rate limiting, logging, tracing, and host routing — all standard net/http middleware."
---
