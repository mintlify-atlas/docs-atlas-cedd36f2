...
<ParamField path="handler" type="http.Handler">
  The registered endpoint handler (after the middleware chain is stripped).
</ParamField>

<ParamField path="middlewares" type="...func(http.Handler) http.Handler">
...
<ParamField path="r" type="Routes" required>
